        ...
        DistributionProject(String name, String baseDir, Version version, String classifier, String extension, File checkoutDir) {
            ...
            if (version.onOrAfter("1.1.0")) {
                this.distFile = new File(
                    checkoutDir,
                    baseDir + "/" + name + "/build/distributions/RatuDB-min-" + version + "-SNAPSHOT" + classifier + "." + extension
                );
            } else {
                this.distFile = new File(
                    checkoutDir,
                    baseDir + "/" + name + "/build/distributions/RatuDB-" + version + "-SNAPSHOT" + classifier + "." + extension
                );
            }
