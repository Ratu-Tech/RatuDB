...
public class VersionProperties {
    ...
    public static String getRatuDB(){
        return ratudb;
    }

    public static Version getRatuDBVersion(){
        return Version.fromString(ratudb);
    }
    ...
    private static final String ratudb;
    private static final Map<String, String> versions = new HashMap<String, String>();

    static {
        Properties props = getVersionProperties();
        opensearch = props.getProperty("opensearch");
        ratudb = props.getProperty("ratudb");
