...
public class RankEvalRequestIT extends ParameterizedOpenSearchIntegTestCase {
    ...
    public void testIndicesOptions() {
        ...
        Detail details = (Detail) response.getPartialResults().get("amsterdam_query").getMetricDetails();
        ...
        details = (Detail) response.getPartialResults().get("amsterdam_query").getMetricDetails();
