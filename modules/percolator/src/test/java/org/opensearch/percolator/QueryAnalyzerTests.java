...
public class QueryAnalyzerTests extends OpenSearchTestCase {
    ...
    public void testExtractQueryMetadata_booleanQuery() {
        ...
        builder.add(termQuery1, Occur.SHOULD);
        ...
        subBuilder.add(termQuery2, Occur.MUST);
        TermQuery termQuery3 = new TermQuery(new Term("_field3", "term5"));
        subBuilder.add(termQuery3, Occur.MUST);
        builder.add(subBuilder.build(), Occur.SHOULD);
    ...
    public void testExtractQueryMetadata_booleanQuery_onlyShould() {
        ...
        subBuilder.add(termQuery3, Occur.SHOULD);
        TermQuery termQuery4 = new TermQuery(new Term("_field3", "_long_term"));
        subBuilder.add(termQuery4, Occur.SHOULD);
        builder.add(subBuilder.build(), Occur.SHOULD);
    ...
    public void testExtractQueryMetadata_booleanQueryWithMustNot() {
        ...
        builder.add(termQuery1, Occur.MUST_NOT);
        PhraseQuery phraseQuery = new PhraseQuery("_field", "_term1", "term2");
        builder.add(phraseQuery, Occur.SHOULD);
        BooleanQuery booleanQuery = builder.build();
    ...
    public void testExactMatch_booleanQuery() {
        ...
        builder.add(phraseQuery1, Occur.SHOULD);
        ...
        builder.add(phraseQuery2, Occur.SHOULD);
        result = analyze(builder.build(), Version.CURRENT);
        ...
        builder = new BooleanQuery.Builder();
        builder.add(termQuery1, randomBoolean() ? Occur.MUST : Occur.FILTER);
        result = analyze(builder.build(), Version.CURRENT);
        ...
        builder = new BooleanQuery.Builder();
        builder.add(termQuery1, randomBoolean() ? Occur.MUST : Occur.FILTER);
        builder.add(termQuery2, randomBoolean() ? Occur.MUST : Occur.FILTER);
        result = analyze(builder.build(), Version.CURRENT);
        assertThat("Also required clauses are taken into account whether the result is verified", result.verified, is(true));
        assertThat(result.minimumShouldMatch, equalTo(2));
        ...
        builder = new BooleanQuery.Builder();
        builder.add(termQuery1, randomBoolean() ? Occur.MUST : Occur.FILTER);
        builder.add(termQuery2, Occur.MUST_NOT);
        result = analyze(builder.build(), Version.CURRENT);
    ...
    public void testBooleanQueryWithMustAndShouldClauses() {
        ...
        builder.add(termQuery2, Occur.SHOULD);
        TermQuery termQuery3 = new TermQuery(new Term("_field", "_term3"));
        builder.add(termQuery3, Occur.MUST);
        Result result = analyze(builder.build(), Version.CURRENT);
        ...
        innerBuilder.add(termQuery1, Occur.SHOULD);
        innerBuilder.add(termQuery2, Occur.SHOULD);
        builder.add(innerBuilder.build(), Occur.MUST);
        builder.add(termQuery3, Occur.MUST);
        result = analyze(builder.build(), Version.CURRENT);
        ...
        builder = new BooleanQuery.Builder();
        builder.add(innerBuilder.build(), Occur.SHOULD);
        builder.add(termQuery3, Occur.MUST);
        result = analyze(builder.build(), Version.CURRENT);
        assertThat("Verified, because m_s_m is specified in an inner clause and not top level clause", result.verified, is(true));
        assertThat(result.minimumShouldMatch, equalTo(1));
    ...
    public void testExtractQueryMetadata_commonTermsQuery() {
        CommonTermsQuery commonTermsQuery = new CommonTermsQuery(Occur.SHOULD, Occur.SHOULD, 100);
    ...
    public void testExtractQueryMetadata_matchNoDocsQuery() {
        ...
        bq.add(new MatchNoDocsQuery("sometimes there is no reason at all"), Occur.MUST);
        ...
        bq.add(new MatchNoDocsQuery("sometimes there is no reason at all"), Occur.SHOULD);
        result = analyze(bq.build(), Version.CURRENT);
        assertThat(result.verified, is(true));
        assertThat(result.minimumShouldMatch, equalTo(1));
    ...
    public void testExtractQueryMetadata_unsupportedQuery() {
        ...
        BooleanQuery.Builder builder = new BooleanQuery.Builder();
        builder.add(termQuery1, Occur.SHOULD);
        builder.add(termRangeQuery, Occur.SHOULD);
    ...
    public void testExtractQueryMetadata_unsupportedQueryInBoolQueryWithMustClauses() {
        ...
        TermQuery termQuery1 = new TermQuery(new Term("_field", "_term"));
        BooleanQuery.Builder builder = new BooleanQuery.Builder();
        builder.add(termQuery1, Occur.MUST);
        builder.add(unsupportedQuery, Occur.MUST);
        BooleanQuery bq1 = builder.build();
        ...
        builder = new BooleanQuery.Builder();
        builder.add(termQuery1, Occur.MUST);
        builder.add(termQuery2, Occur.MUST);
        builder.add(unsupportedQuery, Occur.MUST);
        bq1 = builder.build();
        result = analyze(bq1, Version.CURRENT);
        assertThat(result.verified, is(false));
    ...
    public void testSelectBestResult() {
        ...
        Set<QueryExtraction> queryTerms2 = terms(new int[0], "123", "1234", "12345");
    ...
    public void testPointRangeQuery() {
        ...
        assertFalse(result.verified);
        assertThat(result.minimumShouldMatch, equalTo(1));
        List<QueryExtraction> ranges = new ArrayList<>(result.extractions);
    ...
    public void testPointRangeQuerySelectRanges() {
        ...
        boolQuery.add(LongPoint.newRangeQuery("_field1", 10, 20), Occur.SHOULD);
        boolQuery.add(LongPoint.newRangeQuery("_field2", 10, 15), Occur.SHOULD);
        ...
        boolQuery.add(LongPoint.newRangeQuery("_field1", 10, 20), Occur.FILTER);
        boolQuery.add(LongPoint.newRangeQuery("_field2", 10, 15), Occur.FILTER);
        ...
        boolQuery = new BooleanQuery.Builder();
        boolQuery.add(LongPoint.newRangeQuery("_field1", 10, 20), Occur.FILTER);
        boolQuery.add(LongPoint.newRangeQuery("_field1", 10, 15), Occur.FILTER);
        result = analyze(boolQuery.build(), Version.CURRENT);
        assertFalse(result.verified);
        assertThat(result.minimumShouldMatch, equalTo(1));
        assertEquals(2, result.extractions.size());
        ...
        boolQuery = new BooleanQuery.Builder().setMinimumNumberShouldMatch(2);
        boolQuery.add(LongPoint.newRangeQuery("_field1", 10, 20), Occur.SHOULD);
        boolQuery.add(LongPoint.newRangeQuery("_field1", 10, 15), Occur.SHOULD);
        result = analyze(boolQuery.build(), Version.CURRENT);
        assertFalse(result.verified);
        assertThat(result.minimumShouldMatch, equalTo(1));
        assertEquals(2, result.extractions.size());
    ...
    public void testExtractQueryMetadata_duplicatedClauses() {
        BooleanQuery.Builder builder = new BooleanQuery.Builder();
        builder.add(
            new BooleanQuery.Builder().add(new TermQuery(new Term("field", "value1")), Occur.MUST)
                .add(new TermQuery(new Term("field", "value2")), Occur.MUST)
                .build(),
            Occur.MUST
        );
        builder.add(
            new BooleanQuery.Builder().add(new TermQuery(new Term("field", "value2")), Occur.MUST)
                .add(new TermQuery(new Term("field", "value3")), Occur.MUST)
                .build(),
            Occur.MUST
        );
        builder.add(
            new BooleanQuery.Builder().add(new TermQuery(new Term("field", "value3")), Occur.MUST)
                .add(new TermQuery(new Term("field", "value4")), Occur.MUST)
                .build(),
            Occur.MUST
        );
        Result result = analyze(builder.build(), Version.CURRENT);
    ...
    private static Set<QueryExtraction> terms(int[] intervals, String... values) {
        ...
        for (int interval : intervals) {
            ...
            queryExtractions.add(new QueryExtraction(new QueryAnalyzer.Range("_field", null, null, encodedInterval)));
        }
