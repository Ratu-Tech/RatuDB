...
public class ObjectParserTests extends OpenSearchTestCase {
    ...
    public void testBasics() throws IOException {
        ...
        objectParser.declareField((i, c, x) -> c.test = i.text(), new ParseField("test"), ValueType.STRING);
    ...
    public void testNullDeclares() {
        ...
        Exception e = expectThrows(
            ...
            () -> objectParser.declareField(null, (r, c) -> null, new ParseField("test"), ValueType.STRING)
        );
        ...
        e = expectThrows(
            IllegalArgumentException.class,
            () -> objectParser.declareField((o, v) -> {}, (r, c) -> null, null, ValueType.STRING)
        );
    ...
    public void testDeprecationWarnings() throws IOException {
        ...
        objectParser.declareField((i, v, c) -> v.test = i.text(), new ParseField("test", "old_test"), ValueType.STRING);
        objectParser.parse(parser, s, null);
    ...
    public void testFailOnValueType() throws IOException {
        ...
        objectParser.declareField((i, c, x) -> c.test = i.text(), new ParseField("numeric_value"), ValueType.FLOAT);
