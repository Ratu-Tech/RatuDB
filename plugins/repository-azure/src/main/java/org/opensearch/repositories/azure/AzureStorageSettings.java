...
final class AzureStorageSettings {
    ...
    public static final AffixSetting<Integer> MAX_RETRIES_SETTING = Setting.affixKeySetting(
        AZURE_CLIENT_PREFIX_KEY,
        "max_retries",
        (key) -> Setting.intSetting(key, 3, Property.NodeScope),
        () -> ACCOUNT_SETTING,
        () -> KEY_SETTING
    );
    /**
    ...
    public static final AffixSetting<Integer> PROXY_PORT_SETTING = Setting.affixKeySetting(
        AZURE_CLIENT_PREFIX_KEY,
        "proxy.port",
        (key) -> Setting.intSetting(key, 0, 0, 65535, Property.NodeScope),
        () -> KEY_SETTING,
        () -> ACCOUNT_SETTING,
        () -> PROXY_TYPE_SETTING,
        () -> PROXY_HOST_SETTING
    ...
    private static <T> T getConfigValue(Settings settings, String clientName, AffixSetting<T> clientSetting) {
