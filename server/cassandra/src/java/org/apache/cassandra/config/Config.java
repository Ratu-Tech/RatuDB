...
public class Config
{
    ...
    //Janusgraph 配置
    public int janusgraph_port;
    public int janusgraph_evaluationtimeout;
    public String janusgraph_channelizer;
    public String janusgraph_graphmanager;


    public int janusgraph_maxinitiallinelength;
    public int janusgraph_maxheadersize;
    public int janusgraph_maxchunksize;
    public int janusgraph_maxcontentlength;
    public int janusgraph_maxaccumulationbuffercomponents;
    public int janusgraph_resultiterationbatchsize;
    public int janusgraph_writebufferlowwatermark;
    public int janusgraph_writebufferhighwatermark;


    public Scriptengines janusgraph_scriptengines;

    //Opensearch 配置
    public int opensearch_httpport;
    public int opensearch_transportport;
    public String node_roles;
    public String manager_nodes;
    public Boolean isdisabled_security;
    public String transport_pemcert_filepath;
    public String transport_pemkey_filepath;
    public String transport_pemtrustedcas_filepath;
    public String http_pemcert_filepath;
    public String http_pemkey_filepath;
    public String http_pemtrustedcas_filepath;
    public String trust_store;
    public String truststore_password;
    public String credentials_username;
    public String credentials_password;
    public String nodes_dn;
